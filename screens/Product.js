...
import { StyleSheet, Dimensions, ScrollView,Image,FlatList } from 'react-native';
        ...
        <Block style={styles.product}>
            ...
            <Block flex={false} row margin={[theme.sizes.base,0]}>
                {product.tags.map(tag=>(
                    <Text caption gray  style={styles.tag} key={`tag-${tag}`}>{tag}</Text>
                ))}
            ...
            <Block>
                ...
                <Block row margin={[theme.sizes.padding*0.9,0]}>
                    ...
                    style={styles.more}>
                        <Text gray>+{product.images.slice(1,3).length}</Text>
